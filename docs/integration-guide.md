...
- name: SnapDrift Baseline
  uses: ranacseruet/snapdrift@v0.9.0
  with:
    mode: baseline
...
|-------------|---------------|
| `ranacseruet/snapdrift@v0.9.0` with `mode: baseline` | `ranacseruet/snapdrift/actions/baseline@v0.9.0` |
| `ranacseruet/snapdrift@v0.9.0` with `mode: pr-diff` | `ranacseruet/snapdrift/actions/pr-diff@v0.9.0` |
