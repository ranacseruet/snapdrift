...
import { loadSnapdriftConfig, runBaselineCapture, generateDriftReport, stageArtifacts } from '@snapdrift/adapter-fs';
...
export class LocalProvider {
  ...
  async diff(options) {
    ...
    const comparisonPolicy = config.diff.comparisonPolicy ?? {
      version: 1,
      threshold: config.diff.threshold
    };
    return generateDriftReport({ ...options, comparisonPolicy });
  }
