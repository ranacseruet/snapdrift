...
function isValidCustomViewport(value) {
  return isRecord(value) &&
    Number.isInteger(/** @type {Record<string,unknown>} */ (value).width) &&
    /** @type {Record<string,unknown>} */ (value).width > 0 &&
    Number.isInteger(/** @type {Record<string,unknown>} */ (value).height) &&
    /** @type {Record<string,unknown>} */ (value).height > 0;
}
